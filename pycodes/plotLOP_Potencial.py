...
v_soma3 = dados_lop['v_soma50']
v_soma4 = dados_lop['v_soma50']
lop = dados_lop['lop']
...
hm2 = ax1.pcolormesh(tg, ig, lop, cmap='inferno', vmax=1.0, vmin=0.85)
...
cbar2 = plt.colorbar(hm2, cax=ax3, ticks=[0.85, 1])
